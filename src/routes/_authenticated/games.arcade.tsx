...
function ArcadePage() {
  ...
  return (
    <AppLayout
      title="Game corner"
      subtitle="Winner picks, loser pays"
      critter="penguin"
      critterPose="wave"
    >
      <Link
        to="/games"
        className="press card-soft mb-1 flex items-center gap-3 p-3 text-sm font-bold"
      >
        <span className="text-lg">🏠</span> Back to Our Room
      </Link>
